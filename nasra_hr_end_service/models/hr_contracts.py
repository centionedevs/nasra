...
class HrContract(models.Model):
    ...
    def end_of_contract_notification(self):
        ...
        users = self.env.ref('nasra_hr_end_service.group_end_of_service_notifications').users
        ...
        for contract in contracts:
            notification_temp = self.env.ref('nasra_hr_end_service.mail_template_end_of_contract')
